...
// Supprimer expertise
$stmt = $conn->prepare("DELETE FROM expertise WHERE id_expertise = ?");
$stmt->bind_param("i", $id);
$stmt->execute();

// Nouvel état = même état
$nouvel_etat = $ancien_etat;
$action = "Suppression expertise";
...
header("Location: voir_dossier.php?id=".$id_dossier."&tab=expertise");
exit();
?>